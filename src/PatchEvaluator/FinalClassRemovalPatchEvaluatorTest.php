...
class FinalClassRemovalPatchEvaluatorTest extends TestCase
{
    private FinalClassRemovalPatchEvaluator $evaluator;

    protected function setUp(): void
    {
        $this->evaluator = new FinalClassRemovalPatchEvaluator();
    }
